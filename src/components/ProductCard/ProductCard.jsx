    ...
    <Card className="group cursor-pointer overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-white rounded-2xl mt-0">
      ...
      <CardContent className="px-6 pb-6">
        <div className="space-y-3">
          {/* Product Title */}
          <Link href={`/shop/${product._id}`} className="font-bold text-gray-900 text-2xl line-clamp-2 group-hover:text-primary transition-colors leading-tight hover:text-primary">
            {product.title}
          </Link>
